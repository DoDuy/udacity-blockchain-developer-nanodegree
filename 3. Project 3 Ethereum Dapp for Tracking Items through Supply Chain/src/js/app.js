App = {
    ...
    newUserID: "0x0000000000000000000000000000000000000000",
    ...
    addFarmer: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addFarmer(App.newUserID, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
    ...
    addDistributor: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addDistributor(App.newUserID, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
    ...
    addRetailer: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addRetailer(App.newUserID, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
    ...
    addConsumer: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addConsumer(App.newUserID, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
