...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Require only contract owner call");
        _;
    }
...
//  2) create a public setter using the inherited onlyOwner modifier 
    function setPaused(bool status) public onlyOwner {
        require(_paused != status, "Paused is not changed");
        _paused = status;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Given address to be the owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), to), "Condition fail: msg sender to be the owner of the contract or isApprovedForAll() to be true");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "from address need to be the owner of the given token");
