...
class Block {
    ...
    validate() {
        ...
        return new Promise((resolve, reject) => {
            ...
            resolve(currentBlockHash === recalculateHash);
        });
    }
    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            ...
            let blockDataHex = this.body;
            let decodedDataString = hex2ascii(blockDataHex);
            let decodedDataJson = JSON.parse(decodedDataString);
